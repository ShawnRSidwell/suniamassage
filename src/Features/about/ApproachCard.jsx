  ...
  return (
    <section id="approach">
      <FeatureCard
        ...
        reverse={true}
      >
        <p className="w-11/12 py-2 text-gray-700">
          ...
          and creating an overall feeling of serenity.
        </p>
        <p className="w-11/12 py-2 text-gray-700">
          Each treatment begins with Garshana, where I use silk gloves to
        ...
        <p className="w-11/12 py-2 text-gray-700">
          Each session is personally customized with specific organic
          herbal-infused oils depending on what the client is seeking harmony
          and balance for. The client will guide the intention of each session
          based on their particular needs. The treatment is mostly silent with
          soft music in the background to encourage the client to focus within.
        </p>
      </FeatureCard>
    </section>
  );
