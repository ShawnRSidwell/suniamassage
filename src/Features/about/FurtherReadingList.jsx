...
function FurtherReadingList() {
  return (
    <div className="mx-auto md:px-0 w-11/12 md:w-full flex flex-col items-center justify-center bg-white h-[70dvh] md:h-[50dvh]  shadow md:shadow-none md:max-w-screen-2xl">
