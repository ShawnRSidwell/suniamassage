...
function FurtherReadingList() {
  return (
    <div className="mx-auto md:px-8 w-11/12 md:w-full flex flex-col items-center justify-start bg-white h-[70dvh] md:h-[50dvh] border-2 shadow md:shadow-lg md:max-w-screen-2xl">
