    ...
    <section id="benefits">
      ...
      >
        <p className="w-11/12 py-2 md:py-5 text-gray-700">
          ...
          flexibility, and boost immune function. Additionally, Ayurvedic
          Massage supports mental clarity and emotional balance, making it a
          holistic approach to managing modern life&apos;s demands. Experience a
          revitalizing effect that touches every aspect of your health and
          wellness.
        </p>
