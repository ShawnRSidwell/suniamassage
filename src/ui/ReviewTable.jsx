...
const ReviewCard = ({ review }) => (
  <div className="w-full md:w-[33dvh] mx-auto rounded-lg bg-cPurple-100  p-5 text-gray-800 font-light mb-6 shadow-lg hover:bg-white">
    <div className="w-full flex mb-4 items-center">
      {/* <div className="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
        <img src={review.avatar} alt={review.name} />
      </div> */}
      <div className="flex-grow ">
        <h6 className="font-bold text-sm text-cGreen-500 tracking-wide">
          {review.name}
        </h6>
      </div>
    </div>
    <div className="w-full">
      <p className="text-sm leading-tight tracking-wider font-semibold italic ml-1 ">
        &quot;{review.testimonial}&quot;
      </p>
    </div>
  </div>
            ...
            <div className="w-full max-w-6xl mx-auto">
              <div className="text-center max-w-xl mx-auto">
                ...
                <h3 className="text-xl mb-5 font-light">
                  Hear from our clients about the healing treatments we&apos;ve
                  provided.
                </h3>
              </div>
