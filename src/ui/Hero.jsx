function Hero({ headline, image, children }) {
  return (
    <div className="flex flex-col items-center md:flex-row justify-center gradientbackground  md:bg-[#938ccf] md:h-[80vh] ">
      <div className="md:flex md:justify-evenly items-center text-slate-500 font-medium bg-white rounded-3xl p-3 m-3 md:p-24 md:m-6">
        <img
          className="rounded-full size-4/5 shadow-lg mx-auto md:size-1/2 md:h-96 md:w-96 object-cover md:ml-24 border-[#756DAF]"
          src={image}
          alt="profile picture"
        />
